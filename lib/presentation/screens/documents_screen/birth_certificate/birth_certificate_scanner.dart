...
class BirthCertificateScanner extends StatefulWidget {
  ...
  @override
  State<BirthCertificateScanner> createState() => _BirthCertificateScannerState();
}

class _BirthCertificateScannerState extends State<BirthCertificateScanner> {
