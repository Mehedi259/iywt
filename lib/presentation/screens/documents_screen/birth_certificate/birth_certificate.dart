...
import 'birth_certificate_widget/details.dart';
import 'birth_certificate_widget/requirements.dart';
import 'birth_certificate_widget/status.dart';
import 'birth_certificate_widget/uploads.dart';

class BirthCertificateScannerScreen extends StatefulWidget {
  const BirthCertificateScannerScreen({super.key});

  @override
  State<BirthCertificateScannerScreen> createState() => _BirthCertificateScannerScreenState();
}

class _BirthCertificateScannerScreenState extends State<BirthCertificateScannerScreen> {
